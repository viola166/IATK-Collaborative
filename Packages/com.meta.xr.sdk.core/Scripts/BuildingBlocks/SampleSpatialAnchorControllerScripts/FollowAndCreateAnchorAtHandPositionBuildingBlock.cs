...
namespace Meta.XR.BuildingBlocks
{
    public class FollowAndCreateAnchorAtHandPositionBuildingBlock : MonoBehaviour
    {
        ...
        private void Awake()
        {
            // fixed: _cameraRig = FindAnyObjectByType<OVRCameraRig>();
        ...
        {
            // fixed: var spatialAnchorLocalStorageManagerBuildingBlock = FindAnyObjectByType<SpatialAnchorLocalStorageManagerBuildingBlock>();
            var spatialAnchorLocalStorageManagerBuildingBlock = UnityEngine.Object.FindObjectOfType<SpatialAnchorLocalStorageManagerBuildingBlock>();
