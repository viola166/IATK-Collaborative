...
namespace Meta.XR.BuildingBlocks
{
    public class SpatialAnchorCoreBuildingBlock : MonoBehaviour
    {
        ...
        internal static List<SpatialAnchorCoreBuildingBlock> GetBaseInstances()
        {
            ...
            // fixed: var objects = FindObjectsByType<SpatialAnchorCoreBuildingBlock>(FindObjectsSortMode.None);
            var objects = UnityEngine.Object.FindObjectsOfType<SpatialAnchorCoreBuildingBlock>();
