...
#pragma warning restore CS0162
        ...
        private void Awake()
        {
            // fixed: Assert.AreEqual(1, FindObjectsByType<EnvironmentDepthManager>(FindObjectsInactive.Include, FindObjectsSortMode.None).Length,
            Assert.AreEqual(1, UnityEngine.Object.FindObjectsOfType<EnvironmentDepthManager>(true).Length,
