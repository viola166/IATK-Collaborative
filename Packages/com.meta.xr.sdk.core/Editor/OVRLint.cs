...
#pragma warning restore 618
        ...
        // fixed: var lights = GameObject.FindObjectsByType<Light>(FindObjectsSortMode.None);
        ...
        // fixed: var sources = GameObject.FindObjectsByType<AudioSource>(FindObjectsSortMode.None);
        ...
        // fixed: var renderers = GameObject.FindObjectsByType<Renderer>(FindObjectsSortMode.None);
        ...
        // fixed: var overlays = GameObject.FindObjectsByType<OVROverlay>(FindObjectsSortMode.None);
        var overlays = UnityEngine.Object.FindObjectsOfType<OVROverlay>();
    ...
    static void CheckRuntimeCommonIssues()
    {
        ...
        if (OVRManager.instance != null && !OVRManager.instance.useRecommendedMSAALevel)
        {
            AddFix(eRecordType.RuntimeCommon, "Optimize MSAA",
                ...
                delegate(UnityEngine.Object obj, bool last, int selected)
                {
                    // fixed: var ovrManagers = GameObject.FindObjectsByType<OVRManager>(FindObjectsSortMode.None);
                    var ovrManagers = UnityEngine.Object.FindObjectsOfType<OVRManager>();
