...
namespace Meta.XR.BuildingBlocks.Editor
{
    ...
    public static class SceneListener
    {
        ...
        private static void RecordSceneBlocks()
        {
            ...
            {
                // fixed: var sceneBlocks = Object.FindObjectsByType<BuildingBlock>(FindObjectsSortMode.None);
                var sceneBlocks = UnityEngine.Object.FindObjectsOfType<BuildingBlock>();
