...
namespace Meta.XR.BuildingBlocks.Editor
{
    public class BlockData : BlockBaseData
    {
        ...
        {
            // fixed: return FindObjectsByType<BuildingBlock>(FindObjectsSortMode.None).Any(x => x.BlockId == blockId);
            return UnityEngine.Object.FindObjectsOfType<BuildingBlock>().Any(x => x.BlockId == blockId);
        }
