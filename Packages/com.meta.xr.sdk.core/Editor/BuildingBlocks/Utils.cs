...
namespace Meta.XR.BuildingBlocks.Editor
{
    ...
    internal static class Utils
    {
        ...
        {
            // fixed: return Object.FindObjectsByType<BuildingBlock>(FindObjectsSortMode.None)
            return UnityEngine.Object.FindObjectsOfType<BuildingBlock>()
        ...
        {
            // fixed: return Object.FindObjectsByType<BuildingBlock>(FindObjectsSortMode.None).Where(x => x.BlockId == data.Id)
            return UnityEngine.Object.FindObjectsOfType<BuildingBlock>().Where(x => x.BlockId == data.Id)
                .ToList();
        }
        ...
        {
            // fixed: return Object.FindObjectsByType<T>(FindObjectsSortMode.None)
        ...
        {
            // fixed: return Object.FindObjectsByType<BuildingBlock>(FindObjectsSortMode.InstanceID).ToList();
            return UnityEngine.Object.FindObjectsOfType<BuildingBlock>().ToList();
        }
        ...
        {
            // fixed: return Object.FindObjectsByType<BuildingBlock>(FindObjectsSortMode.None).Where(x =>
            return UnityEngine.Object.FindObjectsOfType<BuildingBlock>().Where(x =>
            {
