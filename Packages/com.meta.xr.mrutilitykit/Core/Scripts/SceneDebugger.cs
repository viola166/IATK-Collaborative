...
namespace Meta.XR.MRUtilityKit
{
    ...
    public class SceneDebugger : MonoBehaviour
    {
        ...
        {
            // fixed: var effectMeshes = FindObjectsByType<EffectMesh>(FindObjectsSortMode.None);
            var effectMeshes = UnityEngine.Object.FindObjectsOfType<EffectMesh>();
        ...
        {
            // fixed: var spaceMaps = FindObjectsByType<SpaceMapGPU>(FindObjectsSortMode.None);
            var spaceMaps = UnityEngine.Object.FindObjectsOfType<SpaceMapGPU>();
