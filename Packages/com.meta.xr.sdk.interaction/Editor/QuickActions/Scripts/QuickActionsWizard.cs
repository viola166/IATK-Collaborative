...
namespace Oculus.Interaction.Editor.QuickActions
{
    internal abstract class QuickActionsWizard : EditorWindow
    {
        ...
        protected class WizardMessages
        {
            ...
            {
                // fixed: if (FindAnyObjectByType<TInteractor>() == null)
                if (UnityEngine.Object.FindObjectOfType<TInteractor>() == null)
                {
                ...
                where TInteractor : Object, IInteractor
            {
                ...
                {
                    // fixed: FindFirstObjectByType<EventSystem>()?.gameObject;
                    GameObject eventSystemGO =
                        UnityEngine.Object.FindObjectOfType<EventSystem>()?.gameObject;
                ...
                // fixed: if (FindAnyObjectByType<PointableCanvasModule>() == null)
                if (UnityEngine.Object.FindObjectOfType<PointableCanvasModule>() == null)
                {
                    string interactorName = typeof(TInteractor).Name;
                    var message = new MessageData(MessageType.Warning,
